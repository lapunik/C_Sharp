        ...
        protected override void OnPaint(PaintEventArgs pe)
        {
            ...
            using (Pen pen = new Pen(ColorOtherwise, 8))
            {
                ...
                if (Second)
                {
                    ...
                    graphics.DrawLine(pen, GetPoint(center, ((sec >= 0.5) ? sec - 0.5 : sec + 0.5), 0.15), GetPoint(center, sec, 0.8));
                }

                pen.Color = ColorOtherwise;
                pen.Width = penWidth;

                graphics.DrawLine(pen, GetPoint(center, ((h >= 0.5) ? h - 0.5 : h + 0.5), 0.15), GetPoint(center, h, 0.6));
                graphics.DrawLine(pen, GetPoint(center, ((min >= 0.5) ? min - 0.5 : min + 0.5), 0.15), GetPoint(center, min, 0.8));


                if (rectangle.Height > rectangle.Width)
                {
                    penWidth = rectangle.Width / 60;
                    pen.Width = penWidth;
                    // graphics.DrawEllipse(pen, (penWidth / 4), ((rectangle.Height - rectangle.Width) / 2) + (penWidth / 3), rectangle.Width - (penWidth - (penWidth / 3)), rectangle.Width - (penWidth - (penWidth / 3)));
                ...
                Font font = null;
                int fontSize;
                string fontName = "Bahnschrift Condensed"; //"Microsoft Tai Le"
